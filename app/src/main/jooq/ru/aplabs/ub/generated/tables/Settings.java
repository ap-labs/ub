...
import ru.aplabs.ub.generated.tables.records.SettingsRecord;
...
public class Settings extends TableImpl<SettingsRecord> {
    ...
    private static final long serialVersionUID = 1034330130;
     ...
     */
    public final TableField<SettingsRecord, String> NAME = createField(DSL.name("name"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "");

    /**
     * The column <code>settings.value</code>.
     */
    public final TableField<SettingsRecord, String> VALUE = createField(DSL.name("value"), org.jooq.impl.SQLDataType.CLOB, this, "");
